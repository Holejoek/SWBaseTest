...
public typealias KeyboardServiceCompletion = (_ keyboardBeginFrame: CGRect, _ keyboardEndFrame: CGRect, _ keyboardBounds: CGRect, _ safeInsets: UIEdgeInsets) -> Void
public typealias KeyboardServiceHeightCompletion = (_ height: CGFloat) -> Void
...
open class KeyboardService: NSObject{
    ...
    open func onShowKeyboard(completion: @escaping KeyboardServiceCompletion){
        onShowKeyboardCallback = completion
    }
    
    open func onHideKeyboard(completion: @escaping KeyboardServiceCompletion){
        onHideKeyboardCallback = completion
    }
    
    open func onChangeHeight(completion: @escaping KeyboardServiceHeightCompletion){
